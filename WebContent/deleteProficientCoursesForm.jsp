...
<title>Delete Proficient Courses</title>
</head>
<body>
<h2>Delete Proficient Courses Form</h2>
...
<% ResultSet r = myUtil.coursesProficientIn(myUtil.getID()); %>
<form action="deleteProficientCoursesHandler.jsp" method="get">
