...
<form action="studentsByCourseAndAvailabilityFormExtension.jsp" method="get">
<p><input type="submit" value="Find peers available to meet"> </p>
...
<%while (r.next()) {
	...
	String length = r.getString(2);	%>
	<tr>
	<th><input type="radio" name="startDateTime" value="<%=startDateTime + "," + length %>"> </th>
	<th><%=r.getString(1) %></th>
	<th><%=r.getString(2) %></th>
</tr>
<% } //while %>
