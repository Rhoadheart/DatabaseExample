...
<title>Add Enrolled Handler</title>
</head>
<body>
<h2>Add Enrolled In Classes Handler</h2>
...
<%
	...
	<% } else {	
	int tuplesAdded = myUtil.addClassesEnrolledIn(myUtil.getID(), courses);
	if(tuplesAdded == 0){ %>
		<h2> Something went wrong, try again.</h2>
	<% } else { %>
		<h2> You added <%=tuplesAdded %> enrolled in courses.</h2>
	<% } }
%>
