...
<title>Delete Enrolled Handler</title>
</head>
<body>
<h2>Delete Enrolled In Courses Handler</h2>
...
<%
	...
	<% } else {	
	int tuplesDeleted = myUtil.deleteEnrolledInCourses(myUtil.getID(), courses);
	if(tuplesDeleted == 0){ %>
		<h2> Something went wrong, try again.</h2>
	<% } else { %>
		<h2> You deleted <%=tuplesDeleted %> enrolled courses.</h2>
	<% } }
%>
